---
title: Ultra Chrome Conflict Crate (lc_conf_defRef_outbreak_tier8_heavyFac)
category: crate
---

# Ultra Chrome Conflict Crate (lc_conf_defRef_outbreak_tier8_heavyFac)
...
## Pool "lcpool_defRef_shrd_conf_tier8_heavyFac" (x1 draw)

### Empire

  * (1/1) 20 data fragments of equipment [Guard Reserve Anti-vehicle](eqpEmpireFactorySummonHeavy)

### Rebellion

  * (1/1) 20 data fragments of equipment [Guard Reserve Anti-vehicle](eqpRebelFactorySummonHeavy)
