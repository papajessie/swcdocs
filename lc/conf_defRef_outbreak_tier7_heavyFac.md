---
title: Obsidian Conflict Crate (lc_conf_defRef_outbreak_tier7_heavyFac)
category: crate
---

# Obsidian Conflict Crate (lc_conf_defRef_outbreak_tier7_heavyFac)
...
## Pool "lcpool_defRef_shrd_conf_tier7_heavyFac" (x1 draw)

### Rebellion

  * (1/1) 10 data fragments of equipment [Guard Reserve Anti-vehicle](eqpRebelFactorySummonHeavy)

### Empire

  * (1/1) 10 data fragments of equipment [Guard Reserve Anti-vehicle](eqpEmpireFactorySummonHeavy)
