---
title: cratetitlelcdailyjetpackoutbreak (lc_daily_jetpack_outbreak)
category: crate
---

# cratetitlelcdailyjetpackoutbreak (lc_daily_jetpack_outbreak)

Crates are given as rewards for various actions. The content is revealed only when opening them, by drawing once (or more) in various prize pools. Only one prize is won for each pool per draw. The in-game description of expectations is written manually and can be wrong. The probability of obtaining one prize is indicated below; the pools change according to planet, faction and HQ level.

This crate expires after 1d. The contents are decided by 4 draws from 3 different pools.
  * 2 draws from pool "lcpool_currency_t1"
  * 1 draw from pool "lcpool_jetpack_outbreak_smpl_daily"
...
## Pool "lcpool_jetpack_outbreak_smpl_daily" (x1 draw)

### Rebellion

  * (1/1) 1 troop sample [Jetpack Trooper](RebelJetpackTrooper)

### Empire

  * (1/1) 1 troop sample [Jump Trooper](EmpireJumptrooper)
