---
title: cratetitlelcdailyepRedCupepisode1 (lc_daily_epRedCup_episode_1)
category: crate
---

# cratetitlelcdailyepRedCupepisode1 (lc_daily_epRedCup_episode_1)
...
This crate expires after 7d. The contents are decided by 4 draws from 3 different pools.
  ...
  * 1 draw from pool "lcpool_epRedCup_daily1"
...
## Pool "lcpool_epRedCup_daily1" (x1 draw)

### Empire

  * (2/4) 2 air support sample [AT-Hauler](EmpireHauler)
  * (2/4) 2 troop sample [AT-DT Walker](EmpireChicken)

### Rebellion

  * (2/4) 2 air support sample [Salvaged AT-Hauler](RebelHauler)
  * (2/4) 2 troop sample [Stolen AT-DT Walker](RebelChicken)
