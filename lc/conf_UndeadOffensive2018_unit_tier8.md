---
title: cratetitlelcconfUndeadOffensive2018unittier8 (lc_conf_UndeadOffensive2018_unit_tier8)
category: crate
---

# cratetitlelcconfUndeadOffensive2018unittier8 (lc_conf_UndeadOffensive2018_unit_tier8)

Crates are given as rewards for various actions. The content is revealed only when opening them, by drawing once (or more) in various prize pools. Only one prize is won for each pool per draw. The in-game description of expectations is written manually and can be wrong. The probability of obtaining one prize is indicated below; the pools change according to planet, faction and HQ level.

This crate expires after 7d. The contents are one draw from each of the 6 pools.

## Pool "lcpool_UndeadOffensive2018_conf_tier8" (x1 draw)

### Rebellion

  * (1/1) 40 troop sample [Undead Trooper](RebelStormDeath)

### Empire

  * (1/1) 40 troop sample [Undead Trooper](EmpireStormDeath)
...
## Pool "lcpool_UndeadOffensive2018_conf_tier8_b" (x1 draw)

### Empire

  * (1/1) 20 troop sample [Heavy Undead Trooper](EmpireHeavyStormDeath)

### Rebellion

  * (1/1) 20 troop sample [Heavy Undead Trooper](RebelHeavyStormDeath)
...
## Pool "lcpool_undeadEvt_unit_conf_tier8" (x1 draw)

### Rebellion

  * (1/1) 32 data fragments of unlockable troop [Modified SD-K4](HeroRebelSpiderDroid)

### Empire

  * (1/1) 32 data fragments of unlockable troop [SD-K4](HeroEmpireSpiderDroid)
